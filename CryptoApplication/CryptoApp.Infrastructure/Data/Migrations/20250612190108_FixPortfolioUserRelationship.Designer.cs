...
namespace CryptoApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250612190108_FixPortfolioUserRelationship")]
    partial class FixPortfolioUserRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoApp.Domain.Models.Identity.CryptoApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CryptoApp.Domain.Models.Portfolio", b =>
                {
                    b.HasOne("CryptoApp.Domain.Models.Identity.CryptoApplicationUser", "User")
                        .WithOne("Portfolio")
                        .HasForeignKey("CryptoApp.Domain.Models.Portfolio", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CryptoApp.Domain.Models.Identity.CryptoApplicationUser", null)
                        .WithMany()
